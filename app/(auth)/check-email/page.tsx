...
<div className="w-96 justify-start text-[var(--color-Text-secondary)] text-base font-normal font-['Host_Grotesk'] leading-5">Password change successfully Click to log in magically.</div>
       ...
       <div className="right flex justify-center items-center">
          ...
          {/* LOGO */}
          {/* FORM */}
          <div className="form px-[24px]  pb-[106px] lg:pb-[40px]">
            <div className="txt text-center mt-[24px]">
              <h1 className='heading-h5 mb-[12px]'>Check your email</h1>
              <p className='medium-regular'>We sent a password reset link to your email. Please check your inbox</p>
            </div>
            <form action="">
            <Button  variant="primary"  label='Open email' />        
            </form>
            <h1 className='text-[var(--color-text-primary)] medium-regular text-center mt-[24px]'>Didn't received the email? <span className='text-[var(--color-Button-primary)] font-semibold'>Resend</span></h1>
